# AgentPack Cursor Extension Skeleton

Status: `skeleton`

This is a VS Code-style extension skeleton for Cursor-shaped hosts. It contributes an `AgentPack: Run Guard` command that runs:

```bash
agentpack guard --agent cursor --repair-stale --refresh-context
```
