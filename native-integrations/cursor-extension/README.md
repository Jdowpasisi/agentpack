...
This is a VS Code-style extension skeleton for Cursor-shaped hosts. It contributes an AgentPack readiness command that defaults to:

```bash
agentpack doctor --agent cursor
```
