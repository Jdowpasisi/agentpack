...
5. Stage 1 writes the run-scoped understanding JSON declared by `agentpack review`.
6. Stage 2 reads that understanding JSON and writes the run-scoped findings JSON declared by `agentpack review`.
