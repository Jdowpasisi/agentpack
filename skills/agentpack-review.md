...
4. Stage 1 writes the run-scoped understanding JSON at the output path declared by `agentpack review`.
5. Stage 2 reads that understanding JSON and writes the run-scoped findings JSON at the output path declared by `agentpack review`.
